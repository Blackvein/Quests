...
public class CreateStagePrompt extends FixedSetPrompt implements ColorUtil {
    ...
    public String getPromptText(ConversationContext context) {
        ...
        try {
            ...
            String text = PINK + "- " + AQUA + context.getSessionData(CK.Q_NAME) + PINK + " | " + Lang.get("stageEditorStage") + " " + PURPLE + stageNum + PINK + " -\n";
            ...
            if (questFactory.quests.citizens != null) {
                ...
                if (context.getSessionData(pref + CK.S_NPCS_TO_TALK_TO) == null) {
                    ...
                    for (Integer npc : npcs) {
                        text += GRAY + "    - " + BLUE + citizens.getNPCRegistry().getById(npc).getName() + "\n";
                    }
    ...
    private class EventListPrompt extends FixedSetPrompt {
        ...
        public String getPromptText(ConversationContext context) {
            ...
            if (context.getSessionData(pref + CK.S_START_EVENT) == null) {
                ...
                text += BLUE + "" + BOLD + "1" + RESET + YELLOW + " - " + Lang.get("stageEditorStartEvent") + " (" + AQUA + context.getSessionData(pref + CK.S_START_EVENT) + YELLOW + ")\n";
            }
            ...
            if (context.getSessionData(pref + CK.S_FINISH_EVENT) == null) {
                ...
                text += BLUE + "" + BOLD + "2" + RESET + YELLOW + " - " + Lang.get("stageEditorFinishEvent") + " (" + AQUA + context.getSessionData(pref + CK.S_FINISH_EVENT) + YELLOW + ")\n";
            }
            ...
            if (context.getSessionData(pref + CK.S_DEATH_EVENT) == null) {
                ...
                text += BLUE + "" + BOLD + "3" + RESET + YELLOW + " - " + Lang.get("stageEditorDeathEvent") + " (" + AQUA + context.getSessionData(pref + CK.S_DEATH_EVENT) + YELLOW + ")\n";
            }
            ...
            if (context.getSessionData(pref + CK.S_DISCONNECT_EVENT) == null) {
                ...
                text += BLUE + "" + BOLD + "4" + RESET + YELLOW + " - " + Lang.get("stageEditorDisconnectEvent") + " (" + AQUA + context.getSessionData(pref + CK.S_DISCONNECT_EVENT) + YELLOW + ")\n";
            }
